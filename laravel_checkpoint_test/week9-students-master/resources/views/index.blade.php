...
<div class="page page-home">
    ...
    <a href="{{url('/student')}}" class="report">Give detention to someone</a>

    <div class="students">
        <a href="{{url('student/harry')}} ">
            <img src="img/harry.jpg" alt="">
        </a>
        <a href="{{url('student/hermione')}}">
            <img src="img/hermione.jpg" alt="">
        </a>
        <a href="{{url('student/ron')}}">
            <img src="img/ron.jpg" alt="">
        </a>
        <a href="{{url('student/tom')}}">
            <img src="img/tom.jpg" alt="">
        </a>
        <a href="{{url('student/luna')}}">

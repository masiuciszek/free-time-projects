...
<div class="page page-student">
    ...
    <section class="detention-assign">
        ...
        <form action="{{url('/student')}} " method="post">
                @csrf
            <input type="text" name="subject" placeholder="Reason for detention" value="{{old('subject')}}   ">

            <textarea name="description" placeholder="Thorough description">{{old('description')}}</textarea>
